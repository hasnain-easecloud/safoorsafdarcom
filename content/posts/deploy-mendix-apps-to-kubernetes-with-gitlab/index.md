...
💥 Congratulations! You have an automated implementation as code for CI/CD Gitlab pipeline. And it will deploy the Mendix application to the Kubernetes cluster. I hope this helps.
